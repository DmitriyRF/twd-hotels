...
if (class_exists('Kirki')) {
	Kirki::add_config( 'silicon-blogger', array(
	...
	Kirki::add_panel( 'header', array(
	  'priority'    => 1,
	  'title'       => esc_html__( 'Header Settings', 'silicon-blogger' ),
	));
	
		/*MENU SETTINGS*/	
		Kirki::add_section( 'menu_settings', array(
			'title'          => __( 'Menu', 'silicon-blogger' ),
			'description'    => __( 'Menu Settings', 'silicon-blogger' ),
			'panel'          => 'header', 
			'priority'       => 1,
			'capability'     => 'edit_theme_options',
		) );
			...
			Kirki::add_field( 'silicon-blogger', array(
				...
				'label'       => esc_attr__( 'Menu Typography', 'silicon-blogger' ),
